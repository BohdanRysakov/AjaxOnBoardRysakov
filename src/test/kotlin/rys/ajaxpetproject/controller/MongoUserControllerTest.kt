...
class MongoUserControllerTest {
    ...
    fun getUserSuccessfullyTest() {
        ...
        mockMvc.perform(
            ...
            .andExpect(jsonPath("$.id.timestamp").value(1694093823))
            .andExpect(jsonPath("$.id.date").value("2023-09-07T13:37:03.000+00:00"))
    ...
    fun getUserFailDueToBadRequestTest() {
        ...
        `when`(userService.findUserById(testMongoUser.id as ObjectId))
            .thenReturn(testMongoUser)
